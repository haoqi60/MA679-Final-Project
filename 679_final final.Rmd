...
```{r fig2, fig.height = 12, fig.width = 10, fig.align = "center",warning = FALSE, message = FALSE, echo = FALSE}
logisdata$recommend=as.factor(logisdata$recommend)
...
```{r fig2, fig.height = 6, fig.width = 8, fig.align = "center", warning = FALSE, message = FALSE, echo = FALSE} 
#correlation
